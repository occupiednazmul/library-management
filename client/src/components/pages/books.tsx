...
export function CreateABook() {
  ...
  function sendBookData(data: TBookNew) {
    console.log(data)
  }
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  ...
                  >
                    <SelectTrigger className='w-full text-base sm:text-xl'>
...
export function EditABook() {
  ...
  function sendBookData(data: TBookUpdate) {
    console.log(data)
  }
  ...
  return (
    <main className='w-full max-w-xl mx-auto font-semibold text-2xl sm:text-4xl'>
      <h1 className='mb-6'>
        <span className='px-6 py-2 bg-indigo-200 rounded-md'>Update Book</span>
      </h1>
      <Form {...newBook}>
        <form
          onSubmit={newBook.handleSubmit(sendBookData)}
